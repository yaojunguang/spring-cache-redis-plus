package com.smarthito.cache.redis.config;
...
import com.smarthito.cache.redis.cache.CustomizedRedisCacheManager;
 ...
 */
@Configuration
public class SpringCacheRedisPlusConfig {
     ...
     */
    @Bean
    public RedisCacheManager cacheManager(LettuceConnectionFactory factory, RedisTemplate<String, Object> redisTemplate) {
        Jackson2JsonRedisSerializer<Object> redisSerializer = new Jackson2JsonRedisSerializer<>(Object.class);
        redisSerializer.setObjectMapper(getObjectMapper());

        RedisCacheConfiguration config = RedisCacheConfiguration.defaultCacheConfig();
        config = config.entryTtl(Duration.ofSeconds(redisDefaultExpiration))
                // 不缓存空值
